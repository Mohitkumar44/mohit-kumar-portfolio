        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <p className="text-muted-foreground leading-relaxed mb-6">
              Mohit Kumar is a B.Tech student at Rajkiya Engineering College Banda, passionate about
              Full Stack Development and problem solving using Data Structures & Algorithms. He is
              focused on building efficient, scalable web applications while continuously improving
